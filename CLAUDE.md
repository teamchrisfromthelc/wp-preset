...
| `plugin/CLAUDE.md`, `theme/` | Kind-specific templates (entry points, agent context) |
...
| `README.md` | User-facing docs. **Never copied into a scaffolded project.** |
...
- When adding a file that should reach projects, add it to the copy list *and*
